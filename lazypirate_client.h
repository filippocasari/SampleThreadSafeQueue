//
// Created by filippocasari on 21/04/21.
//

#ifndef SAMPLETHREADSAFEQUEUE_LAZYPIRATE_CLIENT_H
...
#define SAMPLETHREADSAFEQUEUE_LAZYPIRATE_CLIENT_H

#endif //SAMPLETHREADSAFEQUEUE_LAZYPIRATE_CLIENT_H
